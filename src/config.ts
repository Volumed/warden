...
// Message queue (BullMQ / Redis configuration)

export const MESSAGEQUEUE_ENABLE = process.env.MESSAGEQUEUE_ENABLE === 'true'

export const REDIS_HOST = process.env.REDIS_HOST ?? 'localhost'
export const REDIS_PORT = parseNumber(process.env.REDIS_PORT ?? '6379', 'REDIS_PORT')
...
export const GATEWAY_INTENTS = Intents.Guilds | Intents.GuildMessages | Intents.GuildMembers | Intents.GuildModeration
